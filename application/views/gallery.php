			...
			<!-- gallery -->
				<div class="gallery">
					...
					<div class="gallery-grids">
							...
							<ul id="da-thumbs" class="da-thumbs">
								<li>
									<a href="images/8.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
										<img src="<?=base_url()?>Static/home/images/8.jpg" alt="" />
										<div>
											<h5>Kids School</h5>
								...
								<li>
									<a href="images/9.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
										<img src="<?=base_url()?>Static/home/images/9.jpg" alt="" />
										<div>
											<h5>Kids School</h5>
											<span>non suscipit leo fringilla non suscipit leo fringilla molestie</span>
										</div>
								...
								<li>
									<a href="images/10.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
										<img src="<?=base_url()?>Static/home/images/10.jpg" alt="" />
										<div>
											<h5>Kids School</h5>
											<span>non suscipit leo fringilla non suscipit leo fringilla molestie</span>
										</div>
								...
								<li>
									<a href="images/11.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
										<img src="<?=base_url()?>Static/home/images/11.jpg" alt="" />
										<div>
											<h5>Kids School</h5>
											<span>non suscipit leo fringilla non suscipit leo fringilla molestie</span>
										</div>
								...
								<li>	
									<a href="images/12.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
										<img src="<?=base_url()?>Static/home/images/12.jpg" alt="" />
										<div>
											<h5>Kids School</h5>
											<span>non suscipit leo fringilla non suscipit leo fringilla molestie</span>
										</div>
						...
						<!-- pop-up-script -->
							<script src="<?=base_url()?>Static/home/js/jquery.chocolat.js"></script>
							<!--light-box-files -->
						...
						<!-- //pop-up-script -->
						<script type="text/javascript" src="<?=base_url()?>Static/home/js/jquery.hoverdir.js"></script>
						<script type="text/javascript">
							$(function() {
