...
<!--							</nav>-->
						...
						<div class="col-md-4 event-right">
							...
							<div class="categories">
								<h3>Categories</h3>
								<ul>
									<li><p href="#">At vero eos et accusamus et iusto</p></li>
									<li><p href="#">Sed ut perspiciatis unde omnis iste</p></li>
									<li><p href="#">Accusantium doloremque laudantium</p></li>
									<li><p href="#">Vel illum qui dolorem eum fugiat quo</p></li>
									<li><p href="#">Quis autem vel eum iure reprehenderit</p></li>
